...
// const INTENT_CARDS = [
//     {
//         value: "kahve-buddy", label: "Kahve Buddy", emoji: "☕",
//         colors: ["#EEF0FF", "#DDD8FF"] as const,
//         textColor: "#3730A3", popular: false,
//     },
//     {
//         value: "uzun süreli ilişki", label: "Ciddi İlişki", emoji: "💑",
//         colors: ["#FFF0F8", "#FFD6EC"] as const,
//         textColor: "#9D174D", popular: true,
//     },
//     {
//         value: "kısa süreli ilişki", label: "Takılmalık", emoji: "✨",
//         colors: ["#FFFBF0", "#FEF3C7"] as const,
//         textColor: "#92400E", popular: false,
//     },
//     {
//         value: "dertleşme", label: "Dertleşme", emoji: "💬",
//         colors: ["#F0FBF4", "#D1FAE5"] as const,
//         textColor: "#065F46", popular: false,
//     },
//     {
//         value: "ders arkadaşı", label: "Ders Arkadaşı", emoji: "📚",
//         colors: ["#EFF6FF", "#DBEAFE"] as const,
//         textColor: "#1E40AF", popular: false,
//     },
//     {
//         value: "sürpriz", label: "Sürpriz Eşleşme", emoji: "🎲",
//         colors: ["#F5F0FF", "#EDE9FE"] as const,
//         textColor: "#5B21B6", popular: false,
//     },
// ];
...
//                 params: { phone, intent: intentToUse },
//             });
...
//     if (searching) {
//         return (
//             <SafeAreaView style={{ flex: 1, backgroundColor: "#F0EFFF" }}>
//                 <LinearGradient colors={["#5B4FE8", "#8B5CF6", "#C084FC"]} style={styles.searchingGradient}>
//                     <Text style={styles.logo}>🌴</Text>
//                     <Text style={styles.appNameWhite}>HURMA</Text>
//                 </LinearGradient>
...
//                     </Text>
//                     <LinearGradient colors={["#6C63FF", "#9B8FFF"]} style={styles.selectedIntentBadge}>
//                         <Text style={styles.selectedIntentText}>
//                             {INTENT_CARDS.find(i => i.value === selectedIntent)?.emoji}{" "}
//                             {INTENT_CARDS.find(i => i.value === selectedIntent)?.label}
//                         </Text>
//                     </LinearGradient>
...
//                 >
//                     <Text style={[styles.tabText, { color: activeTab === "match" ? "#6C63FF" : "#aaa" }]}>
//                         Eşleşme Bul
//                     </Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity
...
//                 >
//                     <Text style={[styles.tabText, { color: activeTab === "watch" ? "#6C63FF" : "#aaa" }]}>
//                         İzle
//                     </Text>
//                 </TouchableOpacity>
//             </View>
...
//                             <Text style={[styles.sparkle, { top: 60, left: 120, fontSize: 5 }]}>✦</Text>

//                             {/* Online badge - ortalı */}
//                             <View style={styles.onlineBadgeCenter}>
//                                 <View style={styles.onlineDot} />
//                                 <Text style={styles.onlineBadgeText}>247 kişi şu an online</Text>
//                             </View>

//                             {/* Ortalı yazılar */}
//                             <Text style={styles.heroSubtitleCenter}>Seninle aynı şeyi arayanlar var</Text>
//                             <Text style={styles.heroNameCenter}>{nickname}</Text>

//                             {/* Hero buton - referans görseldeki gibi */}
...
//                                 >
//                                     <View style={styles.heroButtonIconNew}>
//                                         <Text style={{ fontSize: 20 }}>🔍</Text>
//                                     </View>
//                                     <View style={{ flex: 1, alignItems: "center" }}>
//                                         <Text style={styles.heroButtonTitleNew}>Hemen Eşleş</Text>
//                                         <Text style={styles.heroButtonSubNew}>Senin vibe'ında biri seni bekliyor</Text>
//                                     </View>
...
//                         {/* Amacına Göre Eşleş */}
//                         <Text style={styles.sectionTitle}>Amacına Göre Eşleş</Text>
//                         <Text style={styles.sectionSubtitle}>Kahve mi, ilişki mi, dertleşme mi?</Text>
...
//                                         style={[
//                                             styles.intentCard,
//                                             selectedIntent === card.value && styles.intentCardSelected,
//                                         ]}
//                                     >
//                                         {card.popular && (
//                                             <LinearGradient
//                                                 colors={["#E91E63", "#F472B6"]}
...
//                         >
//                             <LinearGradient
//                                 colors={statsOpen ? ["#5B4FE8", "#8B5CF6"] : ["#F8F7FF", "#F0EFFF"]}
//                                 start={{ x: 0, y: 0 }}
//                                 end={{ x: 1, y: 0 }}
//                                 style={styles.statsCardHeader}
//                             >
//                                 <View style={styles.statsCardLeft}>
//                                     <Text style={[styles.statsCardTitle, { color: statsOpen ? "white" : "#1a1a1a" }]}>
//                                         Bugünün İstatistikleri
//                                     </Text>
//                                     <Text style={[styles.statsCardSub, { color: statsOpen ? "rgba(255,255,255,0.7)" : "#aaa" }]}>
//                                         Kaç kişi eşleşti? (Gözat)
//                                     </Text>
//                                 </View>
//                                 <LinearGradient
//                                     colors={statsOpen ? ["rgba(255,255,255,0.3)", "rgba(255,255,255,0.15)"] : ["#6C63FF", "#9B8FFF"]}
//                                     style={styles.arrowBoxNew}
//                                 >
...
//                         <Text style={styles.watchTitle}>Şu an aktif eşleşmeler</Text>
//                         {LIVE_ROOMS.map((room) => (
//                             <TouchableOpacity
//                                 key={room.id}
...
//                                     <View style={{ flex: 1 }}>
//                                         <Text style={styles.roomNames}>{room.anon1} & {room.anon2}</Text>
//                                         <Text style={styles.roomViewers}>👁 {room.viewers} izleyici</Text>
//                                     </View>
...
//                         {nav.id === activeNavTab ? (
//                             <LinearGradient colors={["#6C63FF", "#9B8FFF"]} style={styles.navIconActive}>
//                                 <Text style={{ fontSize: 14 }}>{nav.icon}</Text>
//                             </LinearGradient>
//                         ) : (
//                             <Text style={styles.navIcon}>{nav.icon}</Text>
//                         )}
//                         <Text style={[styles.navLabel, { color: activeNavTab === nav.id ? "#6C63FF" : "#bbb" }]}>
//                             {nav.label}
//                         </Text>
//                     </TouchableOpacity>
//                 ))}
...
//     tabActive: { backgroundColor: "#EEF0FF" },
...
//     heroSubtitle: { color: "rgba(255,255,255,0.75)", fontSize: 13, marginBottom: 3, fontWeight: "500" },
//     heroName: { color: "white", fontSize: 24, fontWeight: "800", marginBottom: 16 },
//     heroButton: {
...
//     },
//     heroButtonTitle: { color: "white", fontSize: 15, fontWeight: "800" },
//     heroButtonSub: { color: "rgba(255,255,255,0.7)", fontSize: 11 },
...
//     // Section
//     sectionTitle: { fontSize: 18, textAlign: "center", fontWeight: "800", color: "#1a1a1a", marginBottom: 3 },
//     sectionSubtitle: { fontSize: 13, textAlign: "center", color: "#888", marginBottom: 14 },
...
//         borderRadius: 12, justifyContent: "center", alignItems: "center",
//     },
//     bottomMatchBtnTitle: { color: "white", fontSize: 15, fontWeight: "800" },
//     bottomMatchBtnSub: { color: "rgba(255,255,255,0.72)", fontSize: 11 },
...
//         borderRadius: 20,
//     },
//     statsCardLeft: { flex: 1 },
//     statsCardTitle: { fontSize: 18, fontWeight: "800", marginBottom: 4 },
//     statsCardSub: { fontSize: 14, fontWeight: "900" },
//     statsCardRight: { flexDirection: "row", alignItems: "center", gap: 10 },
//     liveBadgeInline: {
...
//     },
//     statLabel: { fontSize: 15, fontWeight: "700", marginTop: 4, marginBottom: 3 },
//     statCount: { fontSize: 20, fontWeight: "800" },
//     statSub: { color: "#888", fontSize: 12, marginTop: 2 },

//     // Watch content
//     watchContent: { paddingHorizontal: 16, paddingBottom: 20 },
//     watchTitle: { fontSize: 13, color: "#888", marginBottom: 14, marginTop: 4 },
//     roomCard: {
...
//     roomNames: { fontSize: 13, fontWeight: "500", color: "#1a1a1a", marginBottom: 3 },
//     roomViewers: { fontSize: 11, color: "#aaa" },
//     intentBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
//     intentBadgeText: { fontSize: 11, fontWeight: "500" },
//     watchButton: { backgroundColor: "#EEF0FF", paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10 },
//     watchButtonText: { color: "#6C63FF", fontSize: 12, fontWeight: "600" },
...
//     },
//     logo: { fontSize: 30 },
//     appNameWhite: { fontSize: 18, fontWeight: "800", letterSpacing: 3, color: "white" },
...
//     selectedIntentText: { color: "white", fontSize: 15, fontWeight: "600" },
